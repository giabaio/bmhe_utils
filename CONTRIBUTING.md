# Contributing to `bmhe`

Thank you for taking the time to contribute to the development of `bmhe`. You could find the following guidelines useful in making your contributions.
...
-   Make sure the bug was not already reported in the Github [Issues](https://github.com/giabaio/bmhe_utils/issues).
-   [Open an issue](https://github.com/giabaio/bmhe_utils/issues/new) and clearly describe the issue with as much information as possible. A code sample or an executable test case are recommended.

## Did you plan to write a patch that fixes a bug?

-   [Open an issue](https://github.com/giabaio/bmhe_utils/issues/new) and clearly describe the problem and discuss how your solution will affect `bmhe`.
...
-   Start your work on your fork of the repository. If you haven't done this before, try using `usethis::create_from_github("giabaio/bmhe_utils", fork = TRUE)`.
